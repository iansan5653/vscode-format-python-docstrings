...
describe('extension.ts', function () {
    context('prior to extension activation', function () {
        describe('extension', function () {
            ...
            it('should not be activated on startup', function () {
                let extension = vscode.extensions.getExtension(identifier) as vscode.Extension<any>;
    ...
    context('after extension activation', function () {
        const extension = vscode.extensions.getExtension(identifier) as vscode.Extension<any>;
        ...
        before('activate extension by opening Python file', function () {
            ...
            return vscode.workspace.openTextDocument(__dirname + testPythonFile)
                .then(doc => {
                    document = doc;
        ...
        describe('#installDocformatter()', function () {
            ...
            before('uninstall docformatter if installed', function () {
                ...
                return new Promise(res => {
                    ...
                    ext.promiseExec('pip uninstall docformatter -y')
                        .then(_ => { res(); })
                        .catch(_ => { res(); });
                });
            });
        ...
        describe('#hunksToEdits()', function () {
            ...
            it('should properly format hunks into edits', function () {
                const hunk: Hunk = {
                    ...
                    oldLines: 3,
                    newLines: 4,
                    lines: ['-remove', ' old', '-remove', ' old', '+new', '-remove', '+new'],
                    linedelimiters: ['\n', '\n', '\n', '\n', '\n', '\n', '\n']
                };
                const vsEdit = ext.hunksToEdits([hunk])[0];
        ...
        describe('#buildFormatCommand()', function () {
            ...
            it('should implement the correct defaults', function () {
                assert.strictEqual(ext.buildFormatCommand('path'), 'docformatter path --wrap-summaries 79 --wrap-descriptions 72');
            });
            ...
            context.skip('with modified settings in test folder', function () {
                ...
                before('change the relevant settings', function () {
                    ...
                    return settings.update('wrapSummariesLength', 85, true)
                        .then(_ => {
                ...
                it('should use the new settings', function () {
                    ...
                    assert.strictEqual(ext.buildFormatCommand('path'), 'docformatter path --wrap-summaries 85 --wrap-descriptions 90 --blank --make-summary-multi-line --force-wrap');
                });

                after('reset the settings back to defaults', function () {

                    return settings.update('wrapSummariesLength', undefined, true)
                        .then(_ => {
